...
import updateUser from './router/updateUser.mjs'

import './router/jwt.mjs'
import './router/facebook.mjs'

export {confirm, exists, forgetPassword, login, loginFacebook, register, updatePassword, verifyToken, getUser, updateUser}
